        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6">
          {stats.map((s, i) => (
            <Reveal key={s.label} delay={i * 0.08}>
              <div className="group relative overflow-hidden rounded-3xl border border-royal/15 bg-white/60 p-6 backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:shadow-glow-lg">
                ...
                <s.icon className="h-7 w-7 text-royal" />
                <div className="heading-display mt-5 text-4xl md:text-5xl text-navy count-glow">
                  <Counter
                    to={s.to}
                    suffix={s.suffix}
